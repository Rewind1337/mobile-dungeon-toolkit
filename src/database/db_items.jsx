...
export function init_item_db() {
    ...
    add_equipment(EQUIPMENT_SLOT.ARMOR, "Nova Armor", [PERKS.DEFENCE_FLAT, PERKS.ATTACK_FLAT], "Nova", RARITY.EPIC, ATTRIBUTE.STRENGTH)
    add_equipment(EQUIPMENT_SLOT.RING, "Nova Ring", [PERKS.HEALTH_FLAT], "Nova", RARITY.EPIC, ATTRIBUTE.STRENGTH)
    add_equipment(EQUIPMENT_SLOT.NECKLACE, "Nova Necklace", [PERKS.DEFENCE_FLAT, PERKS.ATTACK_FLAT], "Nova", RARITY.EPIC, ATTRIBUTE.STRENGTH)
    ...
    add_equipment(EQUIPMENT_SLOT.RING, "Elementor Ring", [PERKS.HEALTH_FLAT], "Elementor", RARITY.EPIC, ATTRIBUTE.INTELLIGENCE)
    add_equipment(EQUIPMENT_SLOT.NECKLACE, "Elementor Necklace", [PERKS.DEFENCE_FLAT, PERKS.ATTACK_FLAT], "Elementor", RARITY.EPIC, ATTRIBUTE.INTELLIGENCE)
    ...
    add_equipment(EQUIPMENT_SLOT.ARMOR, "Eclipse Armor", [PERKS.DEFENCE_FLAT, PERKS.ATTACK_FLAT], "Eclipse", RARITY.EPIC, ATTRIBUTE.DEXTERITY)
    add_equipment(EQUIPMENT_SLOT.RING, "Eclipse Ring", [PERKS.HEALTH_FLAT], "Eclipse", RARITY.EPIC, ATTRIBUTE.DEXTERITY)
    add_equipment(EQUIPMENT_SLOT.NECKLACE, "Eclipse Necklace", [PERKS.DEFENCE_FLAT, PERKS.ATTACK_FLAT], "Eclipse", RARITY.EPIC, ATTRIBUTE.DEXTERITY)
