        ...
        <div id='page-splash' className='page flex-col w-100'>
          ...
          <div className='flex-col'>
            <div className='card footer flex-row'>
              <a href='https://www.github.com/rewind1337/mobile-dungeon-toolkit'>
                <Button text={"Source Code"} />
              </a>
              <div className='text flex-row'>
                <div className='text flex-row'>
                  The Game<a href="https://mobiledungeon.com/">
                    <img height={50} src={MDLogo} />
                  </a>
                </div>
                <div className='text flex-row'>
                  and all of the Images used here are owned by
                  <a href="https://www.playa-games.com/">
                    <img height={50} src={PlayaLogo} />
                  </a>
                </div>
                <div className='text flex-row'>
